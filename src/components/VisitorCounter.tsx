...
import { incrementVisitorCount, subscribeToVisitorCount } from '../services/visitorCounterService';
    ...
    useEffect(() => {
        ...
        const initializeCounter = async () => {
            try {
                ...
                // Fallback to 0 if Firebase fails
                setVisitorCount(0);
                setIsLoading(false);
            }
        };
        ...
        // Cleanup: unsubscribe from real-time updates on unmount
        return () => {
            if (unsubscribe) {
                unsubscribe();
            }
